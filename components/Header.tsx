...
const Header: React.FC<HeaderProps> = ({ currentView, onViewChange, onGoHome }) => {
      ...
      { 
        ...
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            ...
            <ellipse cx="12" cy="12" rx="10" ry="4" strokeLinecap="round" strokeLinejoin="round" transform="rotate(45 12 12)" />
            <ellipse cx="12" cy="12" rx="10" ry="4" strokeLinecap="round" strokeLinejoin="round" transform="rotate(-45 12 12)" />
          </svg>
        )
      },
  ...
  return (
    <header className="flex flex-col w-full z-50 sticky top-0 font-sans shadow-xl">
      ...
      <div className="flex items-center px-4 bg-[#0B1221] border-b border-purple-900/20 h-10 md:h-12 select-none relative z-20">
         ...
         {/* Ribbon Tabs */}
         <div className="flex h-full items-end gap-1 overflow-x-auto custom-scrollbar-hide flex-1">
         ...
         {/* Top Right Actions */}
         <div className="ml-auto flex items-center pl-4 border-l border-purple-900/20 h-full">
            <button 
              onClick={onGoHome} 
            ...
            >
                ...
                <span className="text-[10px] uppercase font-bold tracking-wider hidden md:block">Home</span>
            </button>
         </div>
      </div>
